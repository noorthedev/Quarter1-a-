...
console.log(chalk_1.default.blue.bold(" <<<<========>>>> ".concat(chalk_1.default.bgGreenBright(' Wellcome to Anum - Todo-List Application'), " <<<<========>>>>")));
console.log(chalk_1.default.blue.bold("\t\t <<<<<===========================================>>>>>\n"));
//    while(conditions){
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                ...
                return [3 /*break*/, 10];
            case 7:
                if (!(option.choice === "View Todo_list")) return [3 /*break*/, 9];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                console.log("\n ".concat(newTask.task, " task added successfully in todo_list"));
                return [2 /*return*/];
        }
    });
}); };
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                console.log("\n ".concat(deleteTask, " this task has been deleted successfully from your Todo_list\n"));
                return [2 /*return*/];
        }
    });
}); };
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                console.log("\n Task at index number ".concat(update_task_index.index - 1, " update  successfully [ For updated list check option: 'view Todo_list']"));
                return [2 /*return*/];
        }
    });
}); };
